...
let newSum=  (num1, num2,num3,num4)=>` ${num1 + num2 + num3 + num4}`;
...
let newOobjectLit= ()=>({  key1: 'value1',
key2: 'value2',
key3: 'value3',});
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(newOobjectLit());
...
let newMessage=name=>`heloo,${name}`
...
// the arrow functions don’t bind a this and they just use the value of this in their scope 